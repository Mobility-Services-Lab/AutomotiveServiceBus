...
public interface CANMessageConverter {

    Map<Signal, Double> bytesToIntegerValues(byte[] bytes, int identifier)
            throws UnknownIdentifierException;

    byte[] integerValuesToBytes(
            Map<Signal, Double> parameterNamesIntegerValues,
