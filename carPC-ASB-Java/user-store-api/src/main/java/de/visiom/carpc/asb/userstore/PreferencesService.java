...
public interface PreferencesService {
    ...
    List<Preference> getPreferences(String service);

    UserPreference getUserPreference(User user, Preference preference)
            throws NoSuchUserPreferenceException;

    Preference getPreference(String serviceName, String preferenceName)
            throws NoSuchPreferenceException;

    void savePreference(Preference preference, User user, ValueObject valueType);
