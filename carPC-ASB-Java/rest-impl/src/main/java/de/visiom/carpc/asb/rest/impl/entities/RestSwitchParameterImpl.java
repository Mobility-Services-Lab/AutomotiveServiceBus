...
import de.visiom.carpc.asb.rest.parameters.SwitchRestParameter;
...
@XmlRootElement(name = "restSwitchParameter")
public class RestSwitchParameterImpl extends RestParameterImpl implements
        SwitchRestParameter {

    private transient SwitchParameter referenceParameter;

    private final String type = "switch";

    @XmlAttribute
    @XmlJavaTypeAdapter(value = ParameterAdapter.class)
    public SwitchParameter getReferenceParameter() {
        return referenceParameter;
    }

    public void setReferenceParameter(SwitchParameter referenceParameter) {
