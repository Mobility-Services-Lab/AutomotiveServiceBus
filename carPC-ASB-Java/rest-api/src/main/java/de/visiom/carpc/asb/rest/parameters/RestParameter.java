...
public interface RestParameter {
    ...
    Object createValue(Map<Parameter, ValueObject> referenceParameterValues);

    Map<Parameter, ValueObject> getChanges(Object newValue)
            throws IncompatibleValueException;

    List<Parameter> getReferencedParameters();

    boolean isForClusterDisplay();

    Parameter getSubscriptionParameter();
