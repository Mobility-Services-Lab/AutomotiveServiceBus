 ...
 */
package de.visiom.carpc.asb.servicemodel.parameters;
...
public interface Parameter {
    ...
    abstract List<Class<? extends ValueObject>> getCompatibleValueObjects();

    Service getService();

    abstract ValueObject createValueObject(Object object)
